...
public class AddUserController {
	...
	public String processUserForm(@Valid UserForm userForm,BindingResult result, Map model){
		...
		boolean userInserted = adduserservice.checkAddUsers(userForm.getUserId(),userForm.getUserFirstName(),userForm.getUserLastName(),userForm.getUserAddress(),userForm.getUserMobile());
